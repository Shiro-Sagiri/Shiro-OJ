...
public class QuestionSubmitServiceImpl extends ServiceImpl<QuestionSubmitMapper, QuestionSubmit>
    ...
    public LambdaQueryWrapper<QuestionSubmit> getQueryWrapper(QuestionSubmitQueryRequest questionSubmitQueryRequest) {
        ...
        wrapper.eq(ObjectUtil.isNotEmpty(questionId), QuestionSubmit::getUserId, questionId);
        wrapper.eq(ObjectUtil.isNotEmpty(userId), QuestionSubmit::getUserId, userId);
    ...
    public QuestionSubmitVO getQuestionSubmitVO(QuestionSubmit questionSubmit, HttpServletRequest request) {
        ...
        //脱敏(仅管理员和本人可见)
        if (!Long.valueOf(String.valueOf(userId)).equals(questionSubmit.getUserId()) && !userDubboService.isAdmin(request)) {
